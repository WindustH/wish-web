...
<template>
  <div class="config-editor" :data-owner="owner">
    <div class="cfg-heading cfg-heading-actions"><Hint :text="tr('刷新', 'Refresh')"><button type="button" class="btn ghost icon-only" :aria-label="tr('刷新', 'Refresh')" :disabled="busy || catalogBusy" @click="request('reload')"><RefreshCw :size="16" /></button></Hint></div>
