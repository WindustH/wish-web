...
const labels: Record<string, string> = {
  ...
  default_model: '新会话的默认模型', provider: '提供方', model: '模型', reasoning_effort: '思考强度',
  ...
  segment_lower_tokens: '保留原文的片段阈值', segment_upper_tokens: '立即摘要的片段阈值',
  ...
  default_direction: '默认读取方向', default_page_items: '默认每页条目数', max_page_items: '每页条目数上限',
  default_window_before: '定位点之前的默认条目数', default_window_after: '定位点之后的默认条目数', max_window_items: '定位窗口条目数上限',
  preview_text_bytes: '正文预览长度', preview_reasoning_bytes: '思考预览长度', preview_tool_arguments_bytes: '工具参数预览长度',
  preview_tool_result_bytes: '工具结果预览长度', change_feed_default_items: '默认变更条目数', change_feed_max_items: '变更条目数上限',
  min_refresh_interval_ms: '最短刷新间隔', max_history_snapshots_per_source: '每个来源的历史快照上限', history_default_items: '默认历史条目数',
  ...
  capabilities: '模型能力', supports_client_tools: '支持工具调用', supports_reasoning: '支持思考', default_reasoning_effort: '默认思考强度', reasoning_efforts: '思考强度映射',
  ...
  value: '值', region: '地区', access_key_id: '访问密钥 ID', secret_access_key: '访问密钥', session_token: '临时访问令牌', credentials_path: '凭据文件路径',
