...
export declare function blobMetadata(reference: string): Promise<{id:string;mime_type:string;byte_count:number}>;
export declare function sessionCreate(body: any): Promise<any>;
export declare function requireAvailableModel(provider: any, id: string): Promise<void>;
...
export function directoriesList(path: string): Promise<{ path: string; parent: string | null; directories: string[] }>;
