...
defineProps<{ text: string; label: string; focusable?: boolean }>();
</script>

<template>
  <Hint :text="text">
    <span class="info-hint" :tabindex="focusable === false ? undefined : 0" role="img" :aria-label="label"><Info :size="15" /></span>
  </Hint>
</template>
