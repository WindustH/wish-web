...
test('trackpad momentum yields to the spring and a later gesture responds immediately', () => {
  ...
  const elastic = scope.run(() => useElasticOverscroll(ref(viewport), ref(content), ref(true), ref('session')));
  ...
  const wheelUp = deltaY => elastic.wheel({ deltaY, deltaX: 0, deltaMode: 0, ctrlKey: false, target: null });
