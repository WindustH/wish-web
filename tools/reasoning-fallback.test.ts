...
import { setBaseUrl } from '../src/core/api/client.ts';
import { sessionUpdateModel } from '../src/core/api/endpoints.ts';
...
async function patch(provider: object, body: Parameters<typeof sessionUpdateModel>[1]) {
  let captured: any;
