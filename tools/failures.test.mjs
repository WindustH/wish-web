...
import { operationFailure, displayFailure } from '../src/core/api/failures.js';
import { sessionView } from '../src/core/api/projections.js';
const failed = error => ({type:'operation_finished',outcome:{Failed:error}});
